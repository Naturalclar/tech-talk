...
<Head>
  <Meta title="RN の Upgrade に近道なんてねぇんだよ"
  description="RNStartUp #3 での発表"
  slug="no-shortcuts-for-rn-upgrade"
  publishedAt={new Date("2019-03-28")}
  />
</Head>
...
- (57.0) rn-cli.configの変更

---

## `build.gradle` や `.pbxproj` ファイルの変更

- 普通にやろうとすれば Native の知識が必要
