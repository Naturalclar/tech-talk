...
<img
  src="../assets/matsuri-logo.png"
  style={{ position: "absolute", top: 20, left: 20, opacity: 0.2 }}
  width="900"
/>

[React Native Matsuri](https://react-native-meetup.connpass.com/event/225824/)
@naturalclar

{/* ご紹介ありがとうございます。React Native Rearchitecture 2021 というタイトルで登壇させていただきます。Jesse です。 */}
...
{/* Rearchitecture は2018年のReact Confにて発表された */}
